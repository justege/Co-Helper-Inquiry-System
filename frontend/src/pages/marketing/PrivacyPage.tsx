    ...
    <MarketingLayout>
      ...
      <ContentSection narrow>
        <ProseBlock>
          ...
          <p>
            OutsourceSoft ("we", "our", or "us") operates the OutsourceSoft B2B procurement platform. This Privacy
          ...
          <ul>
            ...
            <li>Inquiry and order data: product specifications, quantities, budgets, and attachments</li>
            <li>Communication records: messages exchanged through the platform</li>
          ...
          <ul>
            ...
            <li>To match buyer inquiries with relevant partner offers</li>
          ...
          <p>
            We share inquiry details with verified partners relevant to your request. We do not sell personal data
            to third parties. We may share information with service providers who assist in operating the platform
            (e.g. hosting, email delivery), subject to confidentiality agreements.
          </p>

          <h2>5. Data retention</h2>
          <p>
            We retain account and transaction data for as long as your account is active or as needed to provide
            services. You may request deletion of your account by contacting us at privacy@outsourcesoft.com.
          </p>
          ...
          <p>
            Your data may be processed in Turkey, the European Union, or other countries where our service
