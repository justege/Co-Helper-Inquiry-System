  ...
  return (
    <Flex minH="100vh" bg="white">
      ...
      >
        <Box w="full" maxW="360px">
          ...
          <Text mt={8} fontSize="sm" color="gray.500" textAlign="center" fontWeight="500">
            ...
            <Box as={Link} to="/register" color="indigo.500" fontWeight="700" _hover={{ textDecoration: "underline" }}>
              Sign Up
            </Box>
          </Text>
        </Box>
      ...
      <RightPanel
        ...
        headline={<>Start building<br /><Box as="span" color="yellow.300">faster today.</Box></>}
        features={[
