...
<xs:schema xmlns:ram="urn:un:unece:uncefact:data:standard:ReusableAggregateBusinessInformationEntity:100"
  ...
  <xs:import namespace="urn:un:unece:uncefact:data:standard:QualifiedDataType:100" schemaLocation="FACTUR-X_EXTENDED_QualifiedDataType_100.xsd"/>
  <xs:import namespace="urn:un:unece:uncefact:data:standard:UnqualifiedDataType:100" schemaLocation="FACTUR-X_EXTENDED_UnqualifiedDataType_100.xsd"/>
  ...
  <xs:complexType name="FinancialAdjustmentType">
    <xs:sequence>
  ...
  <xs:complexType name="HeaderTradeSettlementType">
    <xs:sequence>
      ...
      <xs:element name="SpecifiedFinancialAdjustment" type="ram:FinancialAdjustmentType" minOccurs="0" maxOccurs="unbounded"/>
  ...
  <xs:complexType name="TradeProductType">
    <xs:sequence>
      ...
      <xs:element name="ManufacturerTradeParty" type="ram:TradePartyType" minOccurs="0"/>
